...
/* 
   Här ska du skapa ett interface
*/

export const BekkKantina = (/* Här ska propsen in */) => {
  return (
    <p>
...
// TIPS 1: Bruk syntaxen: useSomething<TYPEN HÄR> för hooks.
...
/* 
  Här ska du skapa ditt interface!
*/
