...
// declare module 'is-vegan' {
//     export function isVeganIngredient(ingredient: string): boolean;
//     export function isVeganIngredientList(ingredientList: string[]): boolean;
//     type CheckIngridientReturnType = {
//         nonvegan: string[];
//         flagged: string[];
//     }
